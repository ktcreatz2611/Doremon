function showMessage(response) {
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "Heyy Doremon, when I talk to you, I feel a sense of peace and comfort like never before. I’m not proposing just to call you my girlfriend, but because I want to spend my whole life loving and caring for you. You are my safe place, my happiness, my foreve.";
